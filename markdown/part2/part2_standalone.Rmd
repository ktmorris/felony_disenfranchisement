...
j <- knitr::kable(t, booktabs = T, caption = "(\\#tab:demo-rd) Demographics of Individuals Discharged Before and After EO 181", linesep = "",
                  align = c("l", "c", "c"), "latex") %>% 
  kable_styling(latex_options = c("HOLD_position"),
                full_width = F) 
