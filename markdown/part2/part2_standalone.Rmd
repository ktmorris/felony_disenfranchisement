...
j <- knitr::kable(t, booktabs = T, caption = "(\\#tab:demo-rd) Demographics of \"Control\" and \"intent-to-Treat\" Groups", linesep = "",
                  align = c("l", "c", "c"), "latex") %>% 
  kable_styling(latex_options = c("HOLD_position"),
                full_width = F) 
...
lab <- "\\caption{\\label{tab:demo-rd} Demographics of \"Control\" and \"intent-to-Treat\" Groups}"
insert1 <- "\\fontsize{10}{12}\\selectfont"
...
```{r sensitivity, echo = FALSE, message = F, warning = F, fig.width = 7.5, fig.height = 4, fig.cap = "\\label{fig:sens}Estimated Treatment Effect by Window Size", fig.pos = "H", fig.align = "center"}
j <- readRDS("./temp/window_change_plot.rds")
print(j)
```
