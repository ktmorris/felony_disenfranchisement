...
Although Governor Cuomo signed the executive order on April 18, 2018, an examination of the individuals whose rights were ultimately restored indicates that the program did not go into full effect until later in May. According to the rights restoration data, it is not until May 18^th^ that the majority of individuals discharged from parole had their rights restored prior to discharge.
