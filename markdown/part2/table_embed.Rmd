...
stargazer(date_reg_model_time, date_to_model_time,
          header = F,
          ...
          covariate.labels = c("Days off Parole Before Election", "Days off Parole Before Election\\textsuperscript{2}",
                               ...
                               "Male", "Age (Years)",
                               "Years on Parole"),
          dep.var.labels = c("Registered in 2018", "Voted in 2018"),
          title = "\\label{tab:to-18-logit-short} 2018 Behavior for Control Group",
          table.placement = "H",
          omit = c("race", "felony"),
...
stargazer(models, model4,
          ...
          dep.var.labels = c("Registered in 2018", "Voted in 2018", "Voted in 2016"),
          title = "\\label{tab:to-18-logit} Turnout in General Election",
          table.placement = "H",
          omit = c("race", "felony"),
          keep.stat = c("n", "rsq", "adj.rsq"),
          add.lines=list(c("Race / Ethnicity FE", "X", "X", "X", "X", "X"),
                         c("Felony Class FE", "X", "X", "X", "X", "X")),
          table.layout = "-dm#-t-a-s-n",
          out = "./temp/test.tex",
          notes = "TO REPLACE",
          out.header = F,
...
k <- readRDS("./temp/means_diff_black.rds") %>% 
  select(-Statistic)
j <- knitr::kable(k, booktabs = T, caption = "(\\#tab:re) Turnout and Registration by Treatment Group, Race", linesep = "",
                  align = c("l", "c", "c", "c")) %>% 
  kable_styling(latex_options = c("HOLD_position"),
                full_width = F) %>% 
...
lab <- "\\caption{\\label{tab:re} Turnout and Registration by Treatment Group, Race}"
insert1 <- "\\fontsize{10}{12}\\selectfont"
...
stargazer(iv3b, iv4b, iv3, iv4,
          ...
          add.lines=list(c("Race / Ethnicity FE", "X", "X", "X", "X"),
                         c("Felony Class FE", "X", "X", "X", "X")),
          table.layout = "-dm#-t-a-s-n",
          out = "./temp/test.tex",
          notes = "TO REPLACE",
          out.header = F,
          se = list(iv3_sesb, iv4_sesb, iv3_ses, iv4_ses))
