...
```{r citywide-map, echo = FALSE, fig.width = 5, fig.height = 5, fig.cap = "\\label{fig:citymap}Individuals Incarcerated in 2017 Who Voted Between 2007 and 2016", out.extra = '', fig.pos = "H", fig.align = "center"}
