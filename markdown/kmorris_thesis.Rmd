...
stargazer(bg_reg, bg_reg_black, tract_reg, tract_reg_black,
          ...
          omit.stat = c("f", "ser"))
```
Although the removal of a voter is not generally associated with decreased turnout, we *do* see an impact on turnout in the block groups and census tracts
