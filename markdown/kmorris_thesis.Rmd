...
stargazer(bg_reg, bg_reg_sq, tract_reg, tract_reg_sq,
          ...
          header = F,
          type = "latex",
          covariate.labels = c("Lost Voters", "Lost Voters\\textsuperscript{2}", "Median Income", "Percent Non-Hispanic Black", "Percent Non-Hispanic White",
                               "Percent With Some College", "Median Age", "Percent Democrats", "Percent Noncitizen", "Percent Won by City Council Representative"),
          dep.var.labels = c("Turnout Rate"),
...
Regression Using Basic Analysis - No matching
more text
