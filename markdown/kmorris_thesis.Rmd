...
Because the date of parole discharge is not correlated with turnout, we can conceptualize the timing of Executive Order 181 as a randomly assigned treatment variable. An individual who was released after the EO was signed is part of the intend-to-treat group, and individuals who actually had their rights restored comply with the treatment. As with true randomized control trials, compliance (restoration) is correlated with the outcome of interest (turnout) and therefore must be controlled for.
