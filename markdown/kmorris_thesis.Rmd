...
In order to estimate the impact of felony disenfranchisement at the neighborhood level, I begin by indentifying voters who were inelibile to cast a ballot in the 2017 mayoral election in New York City. In order to identify incarcerated and paroled voters, matching records from the Department of Corrections and the Voter File is necessary. I here use the methodology first developed by Burch [-@Burch2010; -@Burch2011]. I use first, middle, and last names, and dates of birth, to join these two datasets.^[Matching on first and last names and dates of birth can result in false positive matches, especially in large states like New York. Following @Meredith2013, I report estimates of the potential impact of these false positives in the Appendix.]


##Matching {-}
Method.^[Matching on first and last names and dates of birth can result in false positive matches, especially in large states like New York. Following @Meredith2013, I report estimates of the potential impact of these false positives in the Appendix.]
##Geocoding {-}

#Maps {-}
```{r citywide-map, echo = FALSE, fig.width = 5, fig.height = 5, fig.cap = "\\label{fig:citymap}Individuals Incarcerated in 2017 Who Voted Between 2007 and 2016"}
