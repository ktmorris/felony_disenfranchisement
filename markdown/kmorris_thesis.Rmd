...
j
```
At both the tract and block group level, matching results in an untreated group of neighborhoods that looks substantially like our treatment group. As discussed above, the types of neighborhoods targeted by felony disenfranchisement look far different than the average New York City neighborhood. They have far lower incomes and are much less White; they also have lower median ages and more residents are registered as Democrats.
...
stargazer(bg_reg, bg_reg_black, tract_reg, tract_reg_black,
          ...
          column.labels = c("Block Group Level", "Block Group Level", "Tract Level", "Tract Level"),
          header = F,
          type = "latex",
          ...
          title = "(\\#tab:tract-reg) Matching Regression",
          table.placement = "H",
          style = "ajps",
          omit.stat = c("f", "ser"))
```
