...
* Super low turnout
* Immediate effects on future participation - Ariel's paper [@WHITE2019]
* Changes in Notification Laws (M&M)
...
```{r restoration-chart, echo = FALSE, message = F, warning = F, fig.width = 7.5, fig.height = 4, fig.cap = "\\label{fig:restoration-chart}Share of Discharged Parolees Whose Voting Rights Were Restored Prior to Discharge", fig.pos = "H", fig.align = "center"}
...
stargazer(ed_reg,
          ...
          style = "ajps",
          omit.stat = c("f", "ser"),
          notes = "Robust standard errors (clustered by assembly district) in parentheses.",
          omit = "boro")
```
