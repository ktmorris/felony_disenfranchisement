...
stargazer(bg_reg, bg_reg_black, tract_reg, tract_reg_black,
          ...
          header = F,
          type = "latex",
          covariate.labels = c("D(Neighborhood Lost a Voter)", "Share Non-Hispanic Black", "D(Lost Voter) * Share Black", "Constant"),
...
stargazer(bg_reg, bg_reg_sq, tract_reg, tract_reg_sq,
          ...
          header = F,
          type = "latex",
          covariate.labels = c("Lost Voters", "Lost Voters * Share Black", "Median Income (Thousands of Dollars)", "Percent Latino", "Percent Non-Hispanic Black", "Percent Non-Hispanic White",
