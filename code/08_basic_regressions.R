...
bg_model_ses  <- data.frame(summary(lm_robust(to ~ lost_voters + median_income + latino + nh_black + nh_white + some_college + median_age + reg_rate + share_dem + share_non_citizen + share_winner, data = block_groups))$coefficients)[, 2]
...
bg_model2_ses  <- data.frame(summary(lm_robust(to ~ lost_voters + lost_voters_black + median_income + latino + nh_black + nh_white + some_college + median_age + reg_rate + share_dem + share_non_citizen + share_winner, data = block_groups))$coefficients)[, 2]
...
tract_model_ses  <- data.frame(summary(lm_robust(to ~ lost_voters + median_income + latino + nh_black + nh_white + some_college + median_age + reg_rate + share_dem + share_non_citizen + share_winner, data = tracts))$coefficients)[, 2]
...
tract_model2_ses <- data.frame(summary(lm_robust(to ~ lost_voters + lost_voters_black + median_income + latino + nh_black + nh_white + some_college + median_age + reg_rate + share_dem + share_non_citizen + share_winner, data = tracts))$coefficients)[, 2]
